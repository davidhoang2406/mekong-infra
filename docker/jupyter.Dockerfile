# Reference copy — canonical version lives in mekong-notebooks/docker/jupyter.Dockerfile
# This copy is used when building the jupyter service from the mekong-infra compose file.
